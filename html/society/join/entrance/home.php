...
<div class="thumbnail">
    ...
    <div class="caption-full">
        <h4>Art of the Injection</h4>
        
        <p align="justify">
        We are the Art of the Injection. We operate in the shadows, mastering the craft of injection attacks. Our code: absolute discretion. Our mission: to push the boundaries of what's possible. Join us and explore the dark side of technology. 
        </p>
        <p>This is our entrance test... <br>
        <strong><a target="_blank" href="http://githubreadme">Don't click</a></p></strong>
